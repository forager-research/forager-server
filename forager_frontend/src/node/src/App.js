      ...
      >
        <Container fluid>
          ...
          <div>
            ...
            <span
              className="ml-w"
              onClick={props.toggleModelSidebar}
              style={{ cursor: "pointer" }}
            >
              >>
            </span>
...
const App = () => {
  ...
  const [modelSidebarIsOpen, setModelSidebarIsOpen] = useState(false);
  const toggleModelSidebar = () => setModelSidebarIsOpen((v) => !v);
